...
\tikzset{vertex/.style={circle, fill, inner sep=1.3pt, outer sep=1.8pt}}
...
\def\lnode(#1);{
    \ifx\tikz@fillcolor\pgfutil@empty
        \node[vertex,\@vfc,draw=white,line width=1pt] at (#1) {};
    \else
        \node[vertex,\@vfc,draw=\tikz@fillcolor,line width=1pt] at (#1) {};
    \fi
}
